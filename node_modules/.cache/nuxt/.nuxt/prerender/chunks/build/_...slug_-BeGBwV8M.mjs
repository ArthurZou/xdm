import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, withAsyncContext, unref, mergeProps, computed, toValue, getCurrentInstance, onServerPrefetch, toRaw, ref, shallowRef, nextTick, toRef, resolveComponent, defineAsyncComponent, h, reactive, watch, Text, Comment, useSSRContext, provide, cloneVNode, createElementBlock } from 'file:///opt/gm/givememoney/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrRenderSlot } from 'file:///opt/gm/givememoney/node_modules/vue/server-renderer/index.mjs';
import { pascalCase, kebabCase } from 'file:///opt/gm/givememoney/node_modules/scule/dist/index.mjs';
import destr from 'file:///opt/gm/givememoney/node_modules/destr/dist/index.mjs';
import { find, html } from 'file:///opt/gm/givememoney/node_modules/property-information/index.js';
import { toHast } from 'file:///opt/gm/givememoney/node_modules/minimark/dist/hast.mjs';
import { d as useRoute, c as createError, u as useNuxtApp, b as asyncDataDefaults, t as tryUseNuxtApp, a as useRuntimeConfig } from './server.mjs';
import { debounce } from 'file:///opt/gm/givememoney/node_modules/perfect-debounce/dist/index.mjs';
import { withoutTrailingSlash } from 'file:///opt/gm/givememoney/node_modules/ufo/dist/index.mjs';
import { getRequestHeaders } from 'file:///opt/gm/givememoney/node_modules/h3/dist/index.mjs';
import 'file:///opt/gm/givememoney/node_modules/ofetch/dist/node.mjs';
import '../nitro/nitro.mjs';
import 'file:///opt/gm/givememoney/node_modules/hookable/dist/index.mjs';
...
import 'file:///opt/gm/givememoney/node_modules/defu/dist/defu.mjs';
import 'file:///opt/gm/givememoney/node_modules/unctx/dist/index.mjs';
...
import 'file:///opt/gm/givememoney/node_modules/vue-router/vue-router.node.mjs';
...
const localComponentLoaders = {
  Alert: () => import('./Alert-Dli5Gu4r.mjs').then((m) => pickExport(m, "default", "Alert", "./../../../../../app/components/Alert.vue")),
  Counter: () => import('./Counter-3VvLgS-a.mjs').then((m) => pickExport(m, "default", "Counter", "./../../../../../app/components/Counter.vue"))
};
...
//# sourceMappingURL=_...slug_-BeGBwV8M.mjs.map
