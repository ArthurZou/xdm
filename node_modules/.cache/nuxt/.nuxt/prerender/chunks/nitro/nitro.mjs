import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getRouterParam, setHeader, getResponseStatus, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler } from 'file:///opt/gm/givememoney/node_modules/h3/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file:///opt/gm/givememoney/node_modules/ufo/dist/index.mjs';
import destr from 'file:///opt/gm/givememoney/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///opt/gm/givememoney/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///opt/gm/givememoney/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///opt/gm/givememoney/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, defineDriver, prefixStorage } from 'file:///opt/gm/givememoney/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///opt/gm/givememoney/node_modules/unstorage/drivers/fs.mjs';
import crypto from 'node:crypto';
import fsDriver from 'file:///opt/gm/givememoney/node_modules/unstorage/drivers/fs-lite.mjs';
import lruCache from 'file:///opt/gm/givememoney/node_modules/unstorage/drivers/lru-cache.mjs';
import { digest } from 'file:///opt/gm/givememoney/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///opt/gm/givememoney/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///opt/gm/givememoney/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///opt/gm/givememoney/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///opt/gm/givememoney/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///opt/gm/givememoney/node_modules/radix3/dist/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname, resolve, isAbsolute } from 'file:///opt/gm/givememoney/node_modules/pathe/dist/index.mjs';
import sqliteConnector from 'file:///opt/gm/givememoney/node_modules/db0/dist/connectors/node-sqlite.mjs';

const serverAssets = [{"baseName":"server","dir":"/opt/gm/givememoney/server/assets"}];
...
const _47opt_47gm_47givememoney_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js = defineDriver(
  /**
...
storage.mount('internal:nuxt:prerender', _47opt_47gm_47givememoney_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"/opt/gm/givememoney/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"/opt/gm/givememoney/node_modules/.cache/nuxt/.nuxt/cache/nitro/prerender"}));
storage.mount('data', fsDriver({"driver":"fsLite","base":"./.data/kv"}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/opt/gm/givememoney","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/opt/gm/givememoney/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/opt/gm/givememoney/node_modules/.cache/nuxt/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/opt/gm/givememoney/node_modules/.cache/nuxt/.nuxt/cache"}));
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "6342edfc-dad5-4b94-ad80-6df4ad26473a",
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/opt/gm/givememoney/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  }
};
...
const _i6_zOk = eventHandler((event) => {
...
const _nw6O2N = eventHandler(async (event) => {
...
const _vXSnPP = eventHandler(async (event) => {
...
const _lazy_7C7SWM = () => import('../_/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '', handler: _i6_zOk, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/content/sql_dump.txt', handler: _nw6O2N, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/sql_dump.txt', handler: _nw6O2N, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/content/query', handler: _vXSnPP, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/query', handler: _vXSnPP, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_7C7SWM, lazy: true, middleware: false, method: undefined }
];
