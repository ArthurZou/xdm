import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///opt/gm/givememoney/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { getResponseStatusText, getResponseStatus, getQuery, createError, appendResponseHeader } from 'file:///opt/gm/givememoney/node_modules/h3/dist/index.mjs';
import { joinURL } from 'file:///opt/gm/givememoney/node_modules/ufo/dist/index.mjs';
...
import { renderToString } from 'file:///opt/gm/givememoney/node_modules/vue/server-renderer/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///opt/gm/givememoney/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file:///opt/gm/givememoney/node_modules/devalue/index.js';
import { walkResolver } from 'file:///opt/gm/givememoney/node_modules/unhead/dist/utils.mjs';
import { isRef, toValue, hasInjectionContext, inject, ref, watchEffect, getCurrentInstance, onBeforeUnmount, onDeactivated, onActivated } from 'file:///opt/gm/givememoney/node_modules/vue/index.mjs';
